<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="registe.aspx.cs" Inherits="registe" %>


<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<html>
<head>
<title>Learn an Education Category Flat Bootstarp Resposive Website Template | Admission :: w3layouts</title>
		        ...
		        <li class="dropdown">
		            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-calendar"></i><span>Events</span></a>
		             <ul class="dropdown-menu">
			            <li><a href="events.aspx">sport</a></li>
			            <li><a href="events.aspx">annual</a></li>
	...
	<div class="admission">
	   <div class="container">
            ...
            <!-- select-block -->
              ...
              <div class="form-group col-md-12 form-group1">&nbsp;<label class="col-md-7 control-lable" for="sex">gender : </label>
                <div class="col-md-5">
                    <div class="radios">
