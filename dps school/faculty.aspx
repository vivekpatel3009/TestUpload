<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="faculty.aspx.cs" Inherits="facul" %>
	   	 ...
	   	 <div class="faculty_top">
	   	  <div class="col-md-4 faculty_grid">
	   	  	<figure class="team_member">
	   	  		...
	   	  		<div></div>
	   	  		<figcaption><h3 class="person-title"><a href="event_single.aspx">Readable Content </a></h3>
	   	  			<span class="person-deg">Pg, Degree</span>
	   	  			<p><a href="mailto@example.com">info(at)dps.com</a></p>
	   	  			<p>4 Years</p>
