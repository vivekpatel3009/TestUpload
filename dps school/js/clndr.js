...
;(function ( $, window, document, undefined ) {
  ...
  Clndr.prototype.init = function () {
    ...
    $(this.element).aspx("<div class='clndr'></div>");
  ...
  Clndr.prototype.render = function() {
    ...
    if(!this.options.render) {
      this.calendarContainer.aspx(this.compiledClndrTemplate(data));
    } else {
      this.calendarContainer.aspx(this.options.render.apply(this, [data]));
    }
