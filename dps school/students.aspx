<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="students.aspx.cs" Inherits="stu" %>
	   	 ...
	   	 <div class="faculty_top">
	   	  <div class="col-md-4">
	   	  	<figure class="team_member">
	   	  		...
	   	  		<div></div>
	   	  		<figcaption><h3 class="person-title"><a href="course_detail.aspx">Lorem Ipsum</a></h3>
