	...
	<div class="courses_box1">
	   <div class="container">
           <table align="center">
               <tr>
                   <td>
                       <asp:Label ID="Label2" runat="server" Font-Size="Medium" Text="User name"></asp:Label>
                   </td>
                   <td>
                       &nbsp;&nbsp;&nbsp;&nbsp;
                       <asp:TextBox ID="TextBox1" runat="server" class="form-control" 
                           onblur="if (this.value == '') {this.value = 'Enter text here';}" 
                           onfocus="this.value = '';" value="Enter text here" Width="151px"></asp:TextBox>
                   </td>
               </tr>
               <tr>
                   <td>
                   ...
                   <td>
                       ...
                       <asp:TextBox ID="TextBox2" runat="server" class="form-control" 
                           onblur="if (this.value == '') {this.value = 'Enter text here';}" 
                           onfocus="this.value = '';" TextMode="Password" value="Enter text here"></asp:TextBox>
                       <br />
                   </td>
               </tr>
               <tr>
               ...
               <tr>
                   <td class="style4" colspan="2">
                       ...
                       <br />
                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       <asp:Button ID="Button3" runat="server" Text="Forget Password" />
                   </td>
               </tr>
           </table>
